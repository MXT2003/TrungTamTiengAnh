...
public class AdminUserController {
    ...
    public String list(Model model,
        ...
        Page<User> pageData;
        if (q != null && !q.isBlank()) {
            pageData = userRepository.findByUsernameContainingIgnoreCase(q, PageRequest.of(safePage, safeSize));
        } else {
            pageData = userRepository.findAll(PageRequest.of(safePage, safeSize));
        }
